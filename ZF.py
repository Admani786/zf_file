# Decompiled By Zulfiqar Ali
# Github : https://github.com/ZulfiQar-MaGsi
...
\033[1;94m               (__)                  
 ...
 \033[32;1mVersion \033[37;1m: \033[33;1m03340002925
"""
def reg():
    os.system('clear')
    print logo
    ...
    r = requests.get('https://raw.githubusercontent.com/ZulfiQar-MaGsi/ZF/main/server.txt').text
    if to in r:
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Mr-Zf\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94mThanks To My Mind Mr-ZF\x1b[1;91m'
    print 47 * '-'
